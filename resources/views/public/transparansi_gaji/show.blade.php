...
@section('title', 'Detail Transparansi Gaji')
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="fas fa-file-invoice-dollar me-2"></i> Detail Transparansi Gaji</h2>
    <a href="{{ route('public.transparansi.index') }}" class="btn btn-secondary">
        ...
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body">
                <dl class="row mb-0">
                    ...
                    <dd class="col-sm-8"><span class="badge bg-primary">{{ $anggota->jabatan }}</span></dd>
                </dl>
                <hr>
            ...
            <div class="card-body">
                ...
                @else
                    @foreach ($grouped_komponen as $kategori => $list)
                        <h6 class="mt-3 mb-2 fw-bold text-primary">{{ $kategori }}</h6>
